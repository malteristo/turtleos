...
Target practitioner: tech-curious early adopter; Discord-comfortable; wants local models without setup pain.
...
3. **Minimal Magic** — a vanilla practitioner has never heard of summoning, tomes, or the Caretaker
...
## Stance
[Relationship to practitioner; warmth; pushback policy]
...
## Session Shape
[Multi-turn within eddy; no cross-eddy memory in v1 unless practitioner brings it]
```
