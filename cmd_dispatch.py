...
COMMAND_ACT_FALLBACK = {
    ...
    "context": "Context this turn posted — injected blocks, tools, and files.",
...
# Native eddies: these three are withheld from seneschal act rows. The bar itself renders
# only checkpoint and share — release and dissolve are typed, and no button offers them.
