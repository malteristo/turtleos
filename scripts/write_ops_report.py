...
def format_ops_markdown(bundle: dict[str, Any]) -> str:
    ...
    write_paths = bundle.get("write_paths") or {}
    if write_paths.get("section"):
        lines.append(write_paths["section"])

    record_gaps = bundle.get("record_gaps") or {}
    if record_gaps.get("section"):
        lines.append("")
