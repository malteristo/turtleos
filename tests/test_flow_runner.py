...
class FlowRunnerTests(unittest.TestCase):
    ...
    def test_flow_orientation_description(self) -> None:
        ...
        # No Skip button since 2026-08-14 — the orientation names talking
        # as the alternative, because talking is what ends the intake wait.
        self.assertNotIn("Skip", text)
        self.assertIn("start talking", text)
