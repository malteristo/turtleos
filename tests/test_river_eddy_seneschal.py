...
"""
        ...
        with patch("mage.river_bot_enabled", return_value=True), patch(
            ...
            # Since 2026-08-06 an offer needs a register as well as a shape.
            # "suggest a break workout" is operational; the care path is
            # covered in tests/test_offer_register.py.
            "offer_register.offer_is_welcome",
