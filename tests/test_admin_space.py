...
class AdminSpaceMemberResolutionTests(unittest.TestCase):
    ...
    def test_resolve_members_from_registry_keys(self) -> None:
        ...
        keys = resolve_member_keys(
            guild,
            self.REGISTRY,
            member_tokens=["kermit", "guest"],
            message_mentions=[],
            operator_id=1,
        )
        self.assertEqual(keys, ["kermit", "guest"])
