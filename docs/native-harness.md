...
A managed context unit: identity, policy, active plan, thread summary, practice file excerpt, tool evidence, current task, practitioner preference, runtime constraint.
