...
|-----|-----------|------|--------|
| **Discord permalink self-feed (D2/D2b)** | Message or thread link → visible Read embed → thread history when applicable | **0** | **Slices 1–2 shipped** — [chapter](chapters/2026-06-20-discord-permalink-self-feed.md) |
