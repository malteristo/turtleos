...
| §15.6 | Share eddy (practitioner + space) | `share_eddy.py` shim + 6× `share_*` modules, `!share` | same | **Partial** — decomposition complete; space Slice 3 dogfood remains | `test_share_*`, `shake_share_eddy.py` | `2026-07-10-decomposition-share-eddy.md` | **Integrate** — Mini deploy + space Slice 3 dogfood |
