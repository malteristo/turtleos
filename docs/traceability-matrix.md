...
| §13+ | Update announcements (river + hosted-river) | `announcements.py`, `scripts/post_announcement.py` | same | **Aligned** (v1 manual fanout) | `test_announcements` | `design-update-announcements.md` | **Keep** — return-visit subsumed; no auto on_ready |
