...
| §13+ / §15.4 | Hosted river invite + host admin UX | `river_keys`, `admin_experience`, `cmd_admin` | same | **Aligned** (2026-07-28) | `test_admin_experience`, `test_river_keys`, `shake_hosted_river.py` | `design-admin-experience.md` | **Keep** |
