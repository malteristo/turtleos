...
| §15.6 | Share eddy (practitioner + space) | `share_eddy.py`, `share_targets.py`, `share_transcript.py`, `share_storage.py`, `!share` | same | **Partial** — practitioner dogfood complete; decomposition Slices 1–3 done; space deferred | `test_share_*`, `shake_share_eddy.py` | `design-share-eddy.md`, `2026-07-10-decomposition-share-eddy.md` | **Integrate** — Slice 4 `share_policy.py` next; space Slice 3 needs `shared-river` |
