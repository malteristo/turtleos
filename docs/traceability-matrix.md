...
| §15.6 | Share eddy (practitioner + space) | `share_eddy.py`, `share_targets.py`, `!share` | same | **Partial** — practitioner dogfood complete; decomposition Slice 1 done; space deferred | `test_share_eddy`, `test_share_targets`, `shake_share_eddy.py` | `design-share-eddy.md`, `2026-06-25-share-eddy-slice1-dogfood.md`, `2026-07-10-decomposition-share-eddy.md` | **Integrate** — Slice 2 `share_transcript.py` next; space Slice 3 needs `shared-river` |
