...
| §10.2 | Fresh Eyes flow (story surfaces → illumination) | `template/flows/fresh_eyes.md`, `fresh_eyes.py`, `flow_runner.prepare_flow_reads` | same | **Partial** (unit 2026-07-16; live smoke open) | `test_fresh_eyes` | `design-nesrine-ready.md` Ch 3, story-layer vision §4 | **Integrate** — her-river `!flow fresh_eyes` smoke; Quest deferred |
