...
**North star:** [traceability-matrix.md § Choosing the next chapter](../traceability-matrix.md#choosing-the-next-chapter) · **Current shell:** [journeys.md](journeys.md) legacy section · [flows-and-intake.md](flows-and-intake.md)
...
**Example — Feedback:** Practitioner loads **Feedback** mid-thread when something felt good or wrong. Bootstrap pulls thread excerpt; Turtle asks only what's missing (kind, moment, worked / didn't). Outcome: structured summary for the operator — practitioner-initiated, never prompted by River or Turtle. See [hosted-tester-program.md](hosted-tester-program.md).
...
| **Proactive flow offers** | Same as intentions — discoverable, practitioner-initiated |
| **"Turtle Practice"** (practitioner-facing) | Say **flows** / **flow library** |
