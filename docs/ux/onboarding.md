...
**Not required for first success:** loading a flow, checkpoint, `!fetch`, intentions files, compass/boom, a second member.
...
- Use **Turtle Practice** or internal jargon in practitioner-facing copy  
