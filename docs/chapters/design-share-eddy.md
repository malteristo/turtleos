...
`💬 the hosted practitioner replied in shared eddy · [jump to family thread]`
...
- [x] Kermit → the hosted practitioner (1:1) — multiple eddies 2026-06-25 (sender path)
- [x] The hosted practitioner's Continue + first-reply notify (recipient path)
