...
**Thread:** `#physics lab mini universe experiment time test` (`<thread-id>`)  
...
| Item | Value |
|------|--------|
| **Instance** | Mac Mini (`turtle@<turtle-host>`) |
...
*Dogfood: Kermit + Spirit, 2026-06-20. Mini thread `<thread-id>`.*
