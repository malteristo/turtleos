...
Turtle knows the turtle-talk catalog better than most practitioners. River owns acts and contextual buttons. Today River heuristics cover a few cases (Save, Checkpoint intent, Keep-as-plan). The long tail only appears if the practitioner already knows `!`.
