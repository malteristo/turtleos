...
Slice 1b/2; `!focus` is the documented power-practitioner shortcut (design §5.2a).
...
- **Per-practitioner isolation:** an eddy resolving to the hosted practitioner's root wrote *her*
